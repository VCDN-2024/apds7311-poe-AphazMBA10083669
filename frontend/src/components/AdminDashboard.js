...
const AdminDashboard = ({ token }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-blue-900 to-blue-700 p-8">
      <div className="max-w-4xl mx-auto bg-gray-900 rounded-2xl shadow-lg overflow-hidden">
        ...
        {loading ? (
          <div className="p-10 flex items-center justify-center">
            <Loader className="animate-spin text-orange-500 w-10 h-10" />
          </div>
        ) : (
                ...
                <li key={payment._id} className="flex items-center justify-between p-4 bg-gray-800 rounded-lg shadow-md">
                  ...
                  <div className="flex space-x-2">
                    <button
                      ...
                      className={`flex items-center bg-orange-500 text-white px-3 py-1 rounded-lg hover:bg-orange-600 transition-all ${
        ...
        <div className="p-6 bg-gray-800 rounded-b-2xl">
          <h3 className="text-xl font-semibold mb-4 text-orange-500">Add New Admin</h3>
          <form onSubmit={handleAddAdmin} className="space-y-4">
            <input
              ...
              required
              className="w-full p-3 rounded-lg border border-gray-700 bg-gray-700 text-gray-300 placeholder-gray-400 focus:ring-2 focus:ring-orange-500"
            />
            <input
              type="text"
              placeholder="Surname"
